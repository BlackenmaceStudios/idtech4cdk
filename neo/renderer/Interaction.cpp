...
// jmarshall
	if(ent != NULL)
	{
		...
		if(modelSpaceMatrix == NULL)
		{
			...
			matrix[10] = 1;
			matrix[15] = 1;
			R_GlobalPointToLocal( &matrix[0], light->globalLightOrigin, localLightOrigin );
		}
		else {
			R_GlobalPointToLocal( &modelSpaceMatrix[0], light->globalLightOrigin, localLightOrigin );
		}
	}
// jmarshall end
