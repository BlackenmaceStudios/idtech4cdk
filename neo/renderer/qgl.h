...
extern PFNGLGETSYNCIVPROC qglGetSynciv;
...
extern  void ( APIENTRY * qglViewport )(GLint x, GLint y, GLsizei width, GLsizei height);
	...
	#define 	qwglChoosePixelFormat         ChoosePixelFormat
	#define 	qwglDescribePixelFormat       DescribePixelFormat
	#define 	qwglGetPixelFormat            GetPixelFormat
	#define 	qwglSetPixelFormat            SetPixelFormat
