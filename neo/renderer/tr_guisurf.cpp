...
// jmarshall
	idRectangle screenRect = gui->GetScreenRect();
// jmarshall end
	tr.pc.c_guiSurfs++;
...
// jmarshall
	guiModelMatrix[0] = axis[0][0] / screenRect.w;
	guiModelMatrix[4] = axis[1][0] / screenRect.h;
	guiModelMatrix[8] = axis[2][0];
	guiModelMatrix[12] = origin[0];

	guiModelMatrix[1] = axis[0][1] / screenRect.w;
	guiModelMatrix[5] = axis[1][1] / screenRect.h;
	guiModelMatrix[9] = axis[2][1];
	guiModelMatrix[13] = origin[1];

	guiModelMatrix[2] = axis[0][2] / screenRect.w;
	guiModelMatrix[6] = axis[1][2] / screenRect.h;
