...
#define	PROC_FILE_ID				"jmvWorldFile001"

#define WORLD_ENTITIES_FILE_EXT		"entities"
// jmarshall end
...
// jmarshall
	class bmClientEntity *  clientEntity;		// only valid if this entity is spawned as a client entity.
// jmarshall end
...
public:
	...
	// Returns the raw parms for this entity.
	virtual renderEntity_t *GetParms() = 0;
};
...
// jmarshall
	...
	class bmRenderShadowMap *shadowMap;
// jmarshall end
...
// jmarshall end
	...
	virtual idRenderLight   *GetRenderLightInterface( qhandle_t lightHandle ) const = 0; 
