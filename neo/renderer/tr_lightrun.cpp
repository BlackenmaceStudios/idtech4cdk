...
void idRenderSystemLocal::DeriveLightData(class idRenderLightLocal *light) { return R_DeriveLightData( light ); };
void idRenderSystemLocal::FreeLightDefDerivedData(class idRenderLightLocal *light) { R_FreeLightDefDerivedData( light ); } ;