...
#define	BUILD_STRING					"win-" ID_PLATFORM
...
public:
	...
	virtual ID_SYS_HANDLE				DLL_Load( const char *dllName ) = 0;
	virtual void *			DLL_GetProcAddress( ID_SYS_HANDLE dllHandle, const char *procName ) = 0;
	virtual void			DLL_Unload( ID_SYS_HANDLE dllHandle ) = 0;
...
// jmarshall
	...
	virtual void			GrabMouseCursor( bool grab ) = 0;
	virtual long			FileTimeStamp(struct _iobuf *) = 0;
