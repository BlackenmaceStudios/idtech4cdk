...
// jmarshall
	...
	virtual class bmMemoryHandler		*GetUnifiedMemoryHandler( void ) = 0;

								// Returns what editors are currently running.
	virtual int					GetActiveEditors() = 0;

								// Clears the key states		
	virtual void				KeyClearStates( void ) = 0;
