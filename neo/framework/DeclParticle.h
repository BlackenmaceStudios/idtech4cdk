...
public:
	...
	virtual const char *			GetCustomPathName();
	virtual const char *			GetCustomPathDesc();
	virtual int						NumCustomPathParms();
	virtual void					SetCustomPathType( const char *p );
	virtual void					operator=( const idParticleStage &src );
...
// jmarshall
	virtual idParticleStage *AllocStage( void );
// jmarshall end
