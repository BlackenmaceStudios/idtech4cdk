...
// jmarshall end
	...
	virtual int ParseExpression( idParser *src, idWinVar *var = NULL, int component = 0 );
...
protected:
	...
	void EvaluateRegisters(double *registers);
