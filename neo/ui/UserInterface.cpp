...
idUserInterface::~idUserInterface() {
	Free();
}
...
/*
==============
idUserInterfaceManagerLocal::ScriptNames
==============
*/
const char **idUserInterfaceManagerLocal::ScriptNames( void ) {
	return idWindow::ScriptNames;
}
...
void idUserInterfaceLocal::Free() {
	delete desktop;
	desktop = NULL;
}
void idUserInterface::Free() {
	//((idUserInterfaceLocal *)this)->Free();
}
...
/*
==============
idUserInterfaceLocal::AllocWindow
==============
*/
idWindow *idUserInterfaceLocal::AllocWindow( rvGEWindowWrapper::EWindowType type, bool useWindowDC ) {
	...
	switch ( type )
	{
		case rvGEWindowWrapper::WT_NORMAL:
			window = new idWindow ( GetDesktop()->GetDC(), this );
			break;
			
		case rvGEWindowWrapper::WT_BIND:
			window = new idBindWindow ( GetDesktop()->GetDC(), this );
			break;

		case rvGEWindowWrapper::WT_RENDER:
			window = new idRenderWindow ( GetDesktop()->GetDC(), this );
			break;
			
		case rvGEWindowWrapper::WT_CHOICE:
			window = new idChoiceWindow ( GetDesktop()->GetDC(), this );
			break;

		case rvGEWindowWrapper::WT_EDIT:
			window = new idEditWindow ( GetDesktop()->GetDC(), this );
			break;
