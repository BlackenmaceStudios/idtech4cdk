...
void DialogAFBody::LoadBody( const char *name ) {
	...
	if ( body->frictionDirection.ToVec3() != vec3_origin ) {
		idFile_Memory *file = (idFile_Memory *)fileSystem->AllocFileMemory( "frictionDirection" );
	...
	if ( body->contactMotorDirection.ToVec3() != vec3_origin ) {
		idFile_Memory *file = (idFile_Memory *)fileSystem->AllocFileMemory( "contactMotorDirection" );
