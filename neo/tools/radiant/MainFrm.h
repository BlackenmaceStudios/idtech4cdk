...
public:
	CMainFrame();
	void HandleKey(UINT nChar, UINT_PTR nRepCnt, UINT nFlags, bool bDown = true) 
	{
		if (bDown)
...
public:
	...
	afx_msg void OnOpenSoundEditorInGame();
	afx_msg void OnOpenDeclEditor();
	afx_msg void OnOpenMaterialEditor();
	
	afx_msg void OnOpenParticleEditor();
	afx_msg void OnOpenAFEditor();

	afx_msg void OnTestMap();
	afx_msg void OnDevTestMap();
	
	afx_msg void OnBuildAndTestMap();
