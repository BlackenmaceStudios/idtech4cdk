...
// jmarshall
	const idMaterial *		defferedMaterial;
	const idMaterial *		postMaterial;
	const idMaterial *		testLightMaterial;
// jmarshall end
...
// jmarshall - this has to be called by the editor as well.
	virtual void			DrawDefferedPass( int width = SCREEN_WIDTH, int height = SCREEN_HEIGHT );
// jmarshall end
	

	bmClientEntity			*SpawnClientEntity( idDict &spawnArgs, idRenderEntity *renderEntity, idRenderWorld *world );
	virtual void			UpdateClientEntity( bmClientEntity *entity );
	virtual void			FreeClientEntity( bmClientEntity *entity );
// jmarshall
	virtual void			MainMenuFrame( idUserInterface *mainMenuGui, int frametime );
// jmarshall end
...
// jmarshall end
	...
	void					SpawnClientEntity( idDict &spawnArgs, idRenderWorld *world );
	...
	void					DrawDebugGui( void );
private:
	const static int		INITIAL_SPAWN_COUNT = 1;

	idUserInterface			*debugGui;
...
// jmarshall
#include "vehicles/Vehicle_Base.h"
#include "vehicles/Vehicle_Jeep.h"
// jmarshall end
#include "Misc.h"
#include "Actor.h"
