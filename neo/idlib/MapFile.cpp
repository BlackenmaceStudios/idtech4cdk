...
/*
============
idMapFile::WriteGameEntities
============
*/

// jmarshall - doesn't write out any brushes.
bool idMapFile::WriteGameEntities( const char *fileName, const char *ext, bool fromBasePath  ) {
	int i;
	idStr qpath;
	idFile *fp;
	...
	idLib::common->Printf( "----- WriteEntitiesFile -----\n" );
...
bool idMapFile::Write( const char *fileName, const char *ext, bool fromBasePath ) {
	...
	idLib::common->Printf( "writing %s...\n", qpath.c_str() );
// jmarshall - changed to fs_basepath
	if ( fromBasePath ) {
