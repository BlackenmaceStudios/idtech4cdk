...
void idRenderLightLocal::GenerateShadowMap() {
	
	//shadowMap.RenderShadowMap( parms.origin, parms.lightProject[0], parms.lightProject[1], parms.lightProject[2], parms.lightProject[3] );
}
