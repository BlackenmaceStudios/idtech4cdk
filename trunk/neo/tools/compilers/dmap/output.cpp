...
#include "../../../vt/VirtualTextureBuild.h"
...
====================
*/
static void CreateOutputSurfaces( int entityNum, int areaNum ) {
...
====================
*/
static void CreateOutputGeometry( int entityNum ) {
	int		i;
	uEntity_t *e;
...
// jmarshall
	...
	//vtBuilder.Init( dmapGlobals.mapFileBase );

	idStr vtpath = dmapGlobals.mapFileBase;
	vtpath = vtpath.StripPath();
	vtpath = "vt/" + vtpath;


	idStr objpath = vtpath;
	//objf = fileSystem->OpenFileWrite( objpath.c_str() );
	outModel.Init();
// jmarshall end
