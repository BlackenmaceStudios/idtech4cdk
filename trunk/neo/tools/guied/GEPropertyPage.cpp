...
{
	rvGEPropertyPage* page = (rvGEPropertyPage*) GetWindowLongPtr ( hwnd, GWL_USERDATA );
	...
	if ( msg == WM_INITDIALOG )
	{
		...
		SetWindowLongPtr ( hwnd, GWL_USERDATA, (LONG_PTR)page );
		page->mPage = hwnd;
		...
		case WM_NOTIFY:
			...
			{					
				case PSN_APPLY:		
					if ( !Apply ( ) )
					{
						SetWindowLongPtr ( mPage, DWL_MSGRESULT, PSNRET_INVALID );
						return TRUE;
					}
					break;		
