...
)
{
    ...
    dense_row_count = (int)(MAX (0, MIN (knobs [COLAMD_DENSE_ROW] * n_col, n_col)));		// (int) added by Swanny 20/05/05
    dense_col_count = (int)(MAX (0, MIN (knobs [COLAMD_DENSE_COL] * n_row, n_row)));		// (int) added by Swanny 20/05/05
