...
====================
*/
void idRegister::SetToRegs( double *registers ) {
	int i;
	idVec4 v;
	idVec2 v2;
	idVec3 v3;
...
=================
*/
void idRegister::GetFromRegs( double *registers ) {
	idVec4 v;
	idRectangle rect;
...
====================
*/
void idRegisterList::GetFromRegs(double *registers) {
...
void idRegisterList::SetToRegs( double *registers ) {
	int i;
