...
public:
	...
	virtual						~idUserInterfaceLocal() { Free(); }
	virtual void				Free();
	...
	// jmarshall - private UI virtual functions
	virtual idWindow *			AllocWindow( rvGEWindowWrapper::EWindowType type, bool useWindowDC = true );
	// jmarshall end
private:
	bool						active;
	bool						loading;
...
// jmarshall
	virtual const char **		ScriptNames( void );
// jmarshall end
private:
