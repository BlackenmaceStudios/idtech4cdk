...
public:
	...
	virtual void					NewBody( const char *name );
	virtual void					RenameBody( const char *oldName, const char *newName );
	virtual void					DeleteBody( const char *name );

	virtual void					NewConstraint( const char *name );
	virtual void					RenameConstraint( const char *oldName, const char *newName );
	virtual void					DeleteConstraint( const char *name );
...
================
*/
ID_INLINE int idDeclAF::ContentsFromString( const char *str ) {
	int c;
	idToken token;
...
================
*/
ID_INLINE const char *idDeclAF::ContentsToString( const int contents, idStr &str ) {
	str = "";
