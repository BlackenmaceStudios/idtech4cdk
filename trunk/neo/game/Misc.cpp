...
class bmEditorEntity : public idEntity {
public:
	CLASS_PROTOTYPE( bmEditorEntity );
...
CLASS_DECLARATION( idEntity, bmEditorEntity )
END_CLASS

/*
======================
bmEditorEntity::Spawn
======================
*/
void bmEditorEntity::Spawn() {
