...
idCVar pm_walkspeed(				"pm_walkspeed",				"90",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "speed the player can move while walking" );
...
idCVar pm_thirdPersonHeight(		"pm_thirdPersonHeight",		"-10",			CVAR_GAME | CVAR_NETWORKSYNC | CVAR_FLOAT, "height of camera from normal view height in 3rd person" );
