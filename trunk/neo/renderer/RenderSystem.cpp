...
/*
====================
idRenderSystemLocal::GetNewFrameViewdef
====================
*/
viewDef_t* idRenderSystemLocal::GetNewFrameViewdef( void ) {
	static viewDef_t viewDef;
...
void idRenderSystemLocal::RenderViewToViewport( const renderView_t *renderView, idScreenRect *viewport ) {
	...
	if(renderView->depthOnly)
	{
		viewport->x1 = 0;
		viewport->x2 = renderView->width;
		viewport->y1 = 0;
		viewport->y2 = renderView->height;
	}
	else
	{
