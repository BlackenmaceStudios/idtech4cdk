...
// jmarshall - deferred forward rendering stuff
	...
	currentVTRemapImage = ImageFromFunction("_currentVTRemapImage", R_FrameBufferImage );
	ImageFromFunction("_currentVTRemapImage/tangent", R_FrameBufferColorTargetImage );
	ImageFromFunction("_currentVTRemapImage/tangent1", R_FrameBufferColorTargetImage );
	ImageFromFunction("_currentVTRemapImage/normal", R_FrameBufferColorTargetImage );
