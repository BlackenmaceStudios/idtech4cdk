...
public:
	...
	virtual idRenderEntity	*AddClientEntity( idDict &spawnArgs );
	virtual void			FreeClientEntity( idRenderEntity *entity );
	...
	virtual idRenderLight   *GetRenderLightInterface( qhandle_t lightHandle ) const;
	...
	virtual vtPoint_t		VTTrace( int vtAreaId, const idVec3 start, const idVec3 end ) const;
