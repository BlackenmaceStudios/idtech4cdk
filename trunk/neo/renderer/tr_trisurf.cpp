...
//
class idRenderTriSurfaceManagerLocal : public idRenderTriSurfaceManager {
public:
	virtual  struct srfTriangles_s *CopyStaticTriSurf(struct srfTriangles_s const *surf) { return R_CopyStaticTriSurf( surf ); };
	virtual void				AllocStaticTriSurfIndexes(struct srfTriangles_s *surf,int numTris) { R_AllocStaticTriSurfIndexes( surf, numTris ); };
...
idRenderTriSurfaceManager *renderTriSurfaceManager = &renderTriSurfaceManagerLocal;
